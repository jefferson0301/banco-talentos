...
const  Form = () => {
    ...
    const addTalento = async (
        ...
        const res = await axios.post("http://localhost:8803/", {
            nome: inputNome,
            ...
            .then( ({data}) => toast.success("Policial Adicionado com sucesso") )
            .catch( ({data}) => toast.error("Erro ao adicionar policial"+data.error) )
